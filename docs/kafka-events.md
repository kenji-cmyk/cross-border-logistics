...
SSE is not the system of record. Notification keeps only a bounded replay buffer; clients refresh the Order and timeline on reconnect and also send `Last-Event-ID` automatically when available.
